package BigTasks.Task3008.client;

import BigTasks.Task3008.Connection;
import BigTasks.Task3008.ConsoleHelper;
import BigTasks.Task3008.Message;
import BigTasks.Task3008.MessageType;
    ...
    public class SocketThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                ConsoleHelper.writeMessage("Произошла ошибка потока подключения");
                System.exit(1);
            }
            if (clientConnected) {
